...
```text
src/game/    the wheel geometry and physics, seeded spins, the bets and layout, session rules, demo bets
src/render/  the three.js engine and its public API, the wheel, table, tote board and casino room, procedural textures
...
| `npm test` | Run the wheel, physics, bet, layout and session tests |
